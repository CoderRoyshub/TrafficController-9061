      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {stats.map((stat) => (
            <motion.div
              ...
              className="card bg-gradient-to-br from-blue-50 to-white border border-gray-200 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <motion.div
            ...
            className="card bg-white rounded-xl shadow-md hover:shadow-lg"
          >
            <h2 className="text-xl font-bold mb-4 text-gray-900">Real-Time Traffic Map</h2>
            <div className="h-[400px] rounded-lg overflow-hidden border border-gray-200 shadow-lg">
              <MapContainer
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="flex items-center space-x-3">
                        <div className={`h-2.5 w-2.5 rounded-full ${delivery.status === 'In Progress' ? 'bg-yellow-400' : delivery.status === 'Picking Up' ? 'bg-blue-400' : 'bg-green-400'}`} />
